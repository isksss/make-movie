...
- Skia backend は raster surface の frame 生成、Layer 合成、Image layer の基本 mask ネイティブ描画、シンプルな Text layer のネイティブ描画に対応済みです。装飾付き Text / effect の Skia ネイティブ描画は段階的に拡張します。
